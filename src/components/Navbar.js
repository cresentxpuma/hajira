  ...
  return (
    <>
      <nav className="bg-dark-navbg text-light-text shadow-lg w-full flex flex-col md:flex-row items-center py-8 px-12 relative">
        ...
        <div className="mt-14 ml-[30%] flex space-x-14 hidden md:flex">
          <>
            <Link to="/" className="text-[#ededed] hover:text-[#f0c137] transition-colors flex items-center text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl">
              {/* <FaHome className="w-6 h-6 mr-2" /> */}
              HOME
            </Link>
            <Link to="/about" className="text-[#ededed] hover:text-[#f0c137] transition-colors flex items-center text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl">
              {/* <FontAwesomeIcon icon={faLightbulb} className="mr-2 w-6 h-6" /> */}
              ABOUT US
            </Link>
            <Link to="/gallery" className="text-[#ededed] hover:text-[#f0c137] transition-colors flex items-center text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl">
              {/* <FontAwesomeIcon icon={faImages} className="mr-2 w-6 h-6" /> */}
              GALLERY
            </Link>
            <Link to="/refund" className="text-[#ededed] hover:text-[#f0c137] transition-colors flex items-center text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl">
              {/* <FontAwesomeIcon icon={faSyncAlt} className="mr-2 w-6 h-6" /> */}
              REFUND
            </Link>
            <Link to="/addons" className="text-[#ededed] hover:text-[#f0c137] transition-colors flex items-center text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl">
          ...
          <div className="justify-center md:justify-end w-full md:w-auto hidden md:block">
            <button
              ...
              className="text-xs sm:text-sm md:text-base xl:text-lg px-3 lg:px-4 py-2 lg:py-3 text-[#f0c137] bg-gradient-to-r bg-[#000] tracking-wider hover:bg-[#f0c139] hover:text-black rounded-lg transition duration-300 border-solid border-2 border-[#f0c137]"
            >
        ...
        <div className="absolute top-0 right-0 w-full md:w-auto bg-[#f0c137] text-black py-4 px-40 text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl flex flex-col md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-10 rounded-bl-3xl hidden md:flex">
          ...
          <Link to="/contact" className="mx-2 flex text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl">
            ...
            bingehall2024@gmail.com
          </Link>
          <Link to="/contact" className="mx-2 flex text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl">
            <IoLogoWhatsapp className="text-[25px] mr-2" />
            +91 9100111403
          </Link>
