    ...
    return (
        <div className="max-w-7xl mt-20 mx-auto p-8 bg-gray-100 rounded-lg shadow-lg">
            ...
            <ul className="list-disc pl-6 text-xl mb-4">
                ...
                <li>Refunds will be processed within 7 business days and credited to the original payment method. For any questions or to request a cancellation, please contact us via WhatsApp at <strong>9999999999</strong>.</li>
            </ul>
